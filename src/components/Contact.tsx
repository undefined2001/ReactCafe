...
export default function Contact() {
    return (
        <div className="h-4/5 flex justify-evenly mt-40">
            <div className="w-1/2 h-4/5 flex flex-col rounded-md justify-evenly items-center">
                ...
                />
                <h1 className="h-1/2 w-11/12 mono p-2 grid content-center ml-10 mt-10 mr-10 font-mono text-2xl bg-orange-400 rounded-md">
            ...
            <div className="w-1/2 grid bg-orange-400 rounded-md">
                <h1 className="mono self-center justify-self-center text-4xl">CONTACT<br/><br/>
                PHONE-1: 017XXXXXXXX
                <br/><br/>
                PHONE-2: 019XXXXXXXX
                </h1>
